...
export type TranslationKey = keyof typeof en | keyof typeof bulkEn | keyof typeof sprint5En | keyof typeof sprint51En | keyof typeof sprint6En;
export const defaultLocale: Locale = "en";
export const localeStorageKey = "wms-ui-locale";

const messages: Record<Locale, Record<string, string>> = {
  en: { ...en, ...bulkEn, ...sprint5En, ...sprint51En, ...sprint6En },
  "zh-CN": { ...zhCN, ...bulkZhCN, ...sprint5ZhCN, ...sprint51ZhCN, ...sprint6ZhCN },
};
