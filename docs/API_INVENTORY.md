...
| POST | `/api/outbound/{orderId}/serials/commit` | Revalidate and prepare/freeze exact outbound SNs | order line and selected SNs | prepared allocation result | `INVALID_BATCH`, allocation/SN/domain codes |
